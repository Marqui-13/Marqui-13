...
- 🤝 I’m looking to collaborate with other founders/developers/students helping our world. ***Code is open sourrce but not for production for many reasons(random numbers, environment variables, api keys, etc.)
